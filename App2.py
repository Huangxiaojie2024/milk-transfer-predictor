    ...
    try:
        ...
        if data.shape[1] != 84:
            ...
            if st.sidebar.button("Show SHAP Force Plot"):
                ...
                # Check the shape of the SHAP values for the selected class
                if len(shap_values) > class_index and len(shap_values[class_index]) > 0:
                    shap_value = shap_values[class_index]  # Extract SHAP values for the selected class
